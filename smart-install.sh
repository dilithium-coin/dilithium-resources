TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='dilithium.conf'
CONFIGFOLDER='/root/.dilithium'
COIN_DAEMON='dilithiumd'
COIN_CLI='dilithium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/dilithium-coin/dilithium/releases/download/v1.0.0/dilithium-1.0.0-x86_64-linux-gnu.tar.gz'
